...
A machine learning project that predicts house sale prices using the Ames Housing dataset from Kaggle. This project implements a modular ML pipeline with clean code architecture — from data loading and preprocessing to feature engineering, model training, and prediction.
...
### `config.py`
Contains configuration settings, file paths, and hyperparameters for the project.
...
- Creates derived features (TotalSF, TotalBathrooms, HouseAge, IsRemodeled)
...
- Analyzed 81 features across 1,460 houses
